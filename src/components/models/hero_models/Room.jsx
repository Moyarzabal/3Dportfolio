...
export function Room(props) {
  ...
  Object.entries(nodes).forEach(([key, value]) => {
    if (value.geometry && value.geometry.attributes && value.geometry.attributes.position) {
      console.log(`geometry position for ${key}:`, value.geometry.attributes.position);
    }
  });
